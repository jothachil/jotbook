...
import { initDatabase, getAllNotes, getNote, createNote, updateNote, duplicateNote, deleteNote } from './database.js';
...
app.whenReady().then(() => {
  ...
  ipcMain.handle('notes:update', (_event, id, title, content) => updateNote(id, title, content));
